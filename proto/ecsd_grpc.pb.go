...
func (c *eCSdClient) CheckAddress(ctx context.Context, in *CheckAddressRequest, opts ...grpc.CallOption) (*CheckAddressResponse, error) {
	...
	err := c.cc.Invoke(ctx, ECSd_CheckAddress_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *eCSdClient) BatchCheckAddresses(ctx context.Context, in *BatchCheckRequest, opts ...grpc.CallOption) (*BatchCheckResponse, error) {
	...
	err := c.cc.Invoke(ctx, ECSd_BatchCheckAddresses_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *eCSdClient) InspectFilter(ctx context.Context, in *InspectRequest, opts ...grpc.CallOption) (*InspectResponse, error) {
	...
	err := c.cc.Invoke(ctx, ECSd_InspectFilter_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
// UnimplementedECSdServer must be embedded to have forward compatible implementations.
